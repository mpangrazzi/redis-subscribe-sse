...
class Subscribe extends Readable {
  ...
  constructor (options) {
    ...
    if (options.streamOptions && !isObject(options.streamOptions)) {
      throw new TypeError('option `streamOptions` must be an Object')
    }

    if (options.redisOptions && !isObject(options.redisOptions)) {
      throw new TypeError('option `redisOptions` must be an Object')
    }
